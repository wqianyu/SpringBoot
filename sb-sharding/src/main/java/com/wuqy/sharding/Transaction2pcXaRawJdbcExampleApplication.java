...
/**
 * shardingSphere模拟raw jdbc实现分布式强一致性xa事务
 * 2021-1-6
 */
public class Transaction2pcXaRawJdbcExampleApplication {
    ...
    static private DataSource getShardingDatasource() throws IOException, SQLException {
        String fileName = "F:\\git\\gitproject\\SpringBoot\\sb-sharding\\src\\main\\resources\\sharding-databases-tables.yaml";
