...
public class JinhongAccountExample {
    ...
    public String getSaltRange() {
        return saltRange;
    }

    public void setSaltRange(String saltRange) {
        this.saltRange = saltRange == null ? null : saltRange.trim();
    }
